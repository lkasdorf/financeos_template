...
const REPORTS = [
  ...
  _r('propcost', 'Expenses', renderCostPerPropertyReport,
    'Cost of Living — Property',
    'All costs for one property (rent, service charges, utilities, maintenance, staff) — pick a year, see what wohnen warm actually costs'),
